...
//     const accountName = userFirstName + ' ' + userLastName;

//     let userWalletInstanceNaira = await UserWallet.findOne({
//       userId,
//       walletType: "NAIRA"
//     });

//     let userWalletInstanceUSD = null;
//     let accountNumberUSD = "";

//     if (walletType === "naira&usd") {
//       userWalletInstanceUSD = await UserWallet.findOne({
//         userId,
//         walletType: "USD"
//       });
//     }

//     let accountNumberNaira = "";

//     if (!userWalletInstanceNaira) {
//       // Generate a ten-digit account number for NAIRA wallet
//       accountNumberNaira = generateAccountNumber();

//       userWalletInstanceNaira = await UserWallet.create({
//         walletType: "NAIRA",
//         userId,
//         accountName,
//         accountNumber: accountNumberNaira
//       });
//     }

//     // Check separately for "USD" if walletType is "naira&usd"
//     if (walletType === "naira&usd" && !userWalletInstanceUSD) {
//       // Generate a ten-digit account number for USD wallet
//       accountNumberUSD = generateAccountNumber();

//       userWalletInstanceUSD = await UserWallet.create({
//         walletType: "USD",
//         userId,
//         accountName,
...
//       // Send notifications only when creating wallets for the first time
//       const UserNotification = new walletNotification({
//         userId,
//         message: `Welcome! Your USD & Naira Wallets Are Ready!`
//       });
//       await UserNotification.save();

//       const UserNotifications = new walletNotification({
//         userId,
//         message: `Your Naira Account Number: ${accountNumberNaira} & Your Dollar Account Number: ${accountNumberUSD}!`
//       });
//       await UserNotifications.save();
//     }
//     const nairaBalance = userWalletInstanceNaira.balance.naira;
//     const usdBalance = userWalletInstanceNaira.balance.usd;

//     return res.json({
//       message: "Wallets created successfully",
//       userWalletNaira: userWalletInstanceNaira,
//       userWalletUSD: userWalletInstanceUSD,
//       nairaBalance,
//       usdBalance
//     });
//   } catch (error) {
...
// const fund_stripe = async (req, res) => {
//   const email = req.user.email;
//   const {amount} = req.body;
//   let price;
...
//   switch (amount) {
//     case 10:
//       price = 'price_1O1HAdEBeCV6Ve9s9fMaHauP';
//       break;
//     case 20:
//       price = 'price_1O1GuyEBeCV6Ve9s9x8YDsG8'; 
//       break;
//     case 50:
//     price = 'price_1O1Pz6EBeCV6Ve9s0u2qHk71';
//     break;
//     case 100:
//     price = 'price_1O1Q1AEBeCV6Ve9sxklbjNYd';
//     break;
//     case 500:
//     price = 'price_1O1QBWEBeCV6Ve9snZ70m806';
//     break;
//     // Add more cases for other amounts as needed.
//     default:
//       res.status(400).json({ error: "Invalid amount selected." });
//       return;
//   }
//   try {
...
//       ],
//       mode: 'subscription',
//       success_url: 'https://wallet-wb.vercel.app/wallet',
//       cancel_url: 'https://wallet-wb.vercel.app/wallet',
//     });
...
//       const amount = session.amount_total / 100; // Convert from cents to the desired currency.
...
//       const userNotification = new walletNotification({
//         userId,
//         message: `Your wallet has been successfully funded with $${amount} via Stripe.`
//       });
//       await userNotification.save();
...
//       await sendTransactionReceipt(email, transaction);
//   res.status(200).send('Webhook received');
